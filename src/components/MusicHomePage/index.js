...
class MusicHomePage extends Component {
  ...
  // how to create the delete function
  deleteSong = id => {
  ...
  render() {
    ...
    const statusOfListOfSongs = searchResults.length === 0
      ...
      <div className="bg-container">
        <div className="top-sectoin">
          <div className="singer-details">
            <h1>Ed Sheeran</h1>
            <p className="paragraph8">Singer</p>
          </div>
        </div>
        ...
        <div className="bottom-section">
          ...
          {statusOfListOfSongs ? (
            <p className="paragraph9">No Songs Found</p>
          ) : (
